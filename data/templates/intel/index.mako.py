...
_magic_number = 5
_modified_time = 1294130054.955369
_template_filename='/home/udoprog/repo/git/battleplan/battleplan/templates/intel/index.mako'
_template_uri='/intel/index.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n\n')
        # SOURCE LINE 3
        __M_writer(escape(h.form('test', method="post")))
        __M_writer(u'\n    System:<br />\n    ')
        # SOURCE LINE 5
